defmodule EasepickExampleWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(EasepickExampleWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(EasepickExampleWeb.Gettext, "errors", msg, opts)
    end
  end
